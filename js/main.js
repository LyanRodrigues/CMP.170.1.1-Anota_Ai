...
function getHTML_divPostIts() {
  ...
  for (let i = posts.length - 1; i >= 0 && i > posts.length - 7; i--) {
    ...
    switch (color) {
      case 'Amarelo':
        color = 'background-color:#f8ff98;';
        break;
      case 'Azul':
        color = 'background-color:#86baff;';
        break;
      case 'Rosa':
        color = 'background-color:#f6b3ff;';
        break;
      case 'Verde':
        color = 'background-color:#baffe8;';
        break;
      case 'Verde':
        color = 'background-color:#baffe8;';
        break;
      case 'cinza':
        color = 'background-color:#bbbbbb;';
        break;
    }
...
function isPostsNull() {
  return (
    localStorage.getItem(postsKey) == null ||
